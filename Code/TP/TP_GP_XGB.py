...
round_99_T = find_threshold_round(rmse_T_per_round, pct=0.99)
round_99_P = find_threshold_round(rmse_P_per_round, pct=0.99)
print(f"99% improvement — T: {round_99_T} trees, P: {round_99_P} trees")
...
ax1.axvline(round_99_T,   color='red', linewidth=2, linestyle='--', label=f'99% thresh. @ {round_99_T}')
...
ax2.axvline(round_99_P,   color='red', linewidth=2, linestyle='--', label=f'99% thresh. @ {round_99_P}')
...
# ── NN depth guidance ─────────────────────────────────────────────────────────
max_trees = max(round_99_T, round_99_P)
