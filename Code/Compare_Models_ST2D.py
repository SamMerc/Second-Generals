...
plot_save_path  = base_dir + 'Plots/Model_Compare_Plots/ST2D/'
check_and_make_dir(plot_save_path)   # only the plot dir is ever written to

raw_inputs    = raw_ST_data[:, :4]
...
MODEL_CONFIGS = [
    ...
    # GPNNA - Encoder-Decoder
    {
        'label'       : 'GPNNA - Encoder/Decoder - Baseline',
        'ckpt'        : '',
        'seed'        : 6,
        'model_type'  : 'gpnna',
        'n_neighbors' : 10,
